...
public class VaultOperationsAccessDeniedTests extends MuleArtifactFunctionalTestCase {
    ...
    @Test
    public void testWriteSecretAccessDenied() throws Exception {
        try {
    ...
    @Test
    public void testEncryptDataAccessDenied() throws Exception {
        try {
    ...
    @Test
    public void testDecryptDataAccessDenied() throws Exception {
        try {
    ...
    @Test
    public void testReencryptDataAccessDenied() throws Exception {
        try {
