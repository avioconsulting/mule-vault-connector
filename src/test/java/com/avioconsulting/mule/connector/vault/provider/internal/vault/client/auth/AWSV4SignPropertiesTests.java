...
public class AWSV4SignPropertiesTests {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][] {
                {"http://sts.amazonaws.com", "sts.amazonaws.com", "", Collections.emptyMap()},
                {"https://sts.amazonaws.com", "sts.amazonaws.com", "", Collections.emptyMap()},
                {"https://sts.amazonaws.com/", "sts.amazonaws.com", "/", Collections.emptyMap()},
                {"https://sts.amazonaws.com/?", "sts.amazonaws.com", "/", Collections.emptyMap()},
                {"https://sts.amazonaws.com/?Action", "sts.amazonaws.com", "/", Collections.emptyMap()},
                {"https://sts.amazonaws.com/?Action=", "sts.amazonaws.com", "/", Collections.emptyMap()},
                {"https://sts.amazonaws.com/?Action=GetCallerIdentity", "sts.amazonaws.com", "/", Collections.singletonMap("Action", "GetCallerIdentity")},
                {"https://sts.amazonaws.com/?Action=Your%20text", "sts.amazonaws.com", "/", Collections.singletonMap("Action", "Your text")},
                {"https://sts.amazonaws.com/?Action=GetCallerIdentity&Version=2011-06-15", "sts.amazonaws.com", "/", ImmutableMap.of("Action", "GetCallerIdentity", "Version", "2011-06-15")},
                {"https://sts.amazonaws.com/?Action=GetCallerIdentity&Version=2011-06-15", "sts.amazonaws.com", "/", ImmutableMap.of("Action", "GetCallerIdentity", "Version", "2011-06-15")},
                {"https://sts.amazonaws.com?Action=GetCallerIdentity&Version=2011-06-15", "sts.amazonaws.com", "", ImmutableMap.of("Action", "GetCallerIdentity", "Version", "2011-06-15")},
                {":invalid-url.com", "sts.amazonaws.com", "/", Collections.emptyMap()},
        });
    }
